...
export default ({ crop, crop_urdu, varieties_eng, varieties_urdu, onClick}: { crop: string, crop_urdu: string, varieties_eng: string, varieties_urdu: string, onClick: MouseEventHandler }) => {
  ...
  return (
    <div className='w-full h-72 font-tahoma text-sm flex flex-col justify-between'>
      ...
      <div className="w-44 self-center">
        <Btn color="bg-secondary" textColor="text-white" onClick={onClick}>Management Practices</Btn>
      </div>
    </div>
  )
}